					...
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr onclick="view(<?php echo $msg['knowledge_id'] ?>)">
								...
								<td>
									<a href="userController.php?flag=user&src=k1&edit=<?php echo $msg['knowledge_id']?>" class="btn btn-info btn-operate"><i class="fa fa-pencil"></i>&nbsp;编辑</a>
									<a href="userController.php?flag=user&src=k1&delete=<?php echo $msg['knowledge_id'] ?>" class="btn btn-danger btn-operate" onclick="return confirm('确定要删除吗?删除后不可恢复!');"><i class="fa fa-trash-o"></i>&nbsp;刪除</a>
								</td>
							</tr>
							<?php endforeach ?>
						</tbody>
