	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10">
				...
				<table class="table table-bordered table-striped page-main">
					<thead>
						<tr>
							<th>UUID</th>
							<th>用户名</th>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="" class="btn btn-info btn-operate" data-toggle="modal" data-target="#userEdit"  data-id="edit">编辑</a>
								<a href="adminController.php?flag=admin&src=u1&delete=<?php echo $user['user_id'] ?>" class="btn btn-danger btn-operate" onclick="return confirm('确定要删除吗');">刪除</a>
							</td>
						</tr>
						<?php endforeach; ?>
					</tbody>
