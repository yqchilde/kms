					...
					<form id="msgPost" method="post" class="page-main-post">
						<div class="form-group">
							...
							<select id="type" name="type" class="form-control">
                                ...
                                switch ($msg['type_id']) {
                                    case '1':
                                        echo "<option value='1' selected = 'selected'>文章库</option>";
                                        echo "<option value='2'>代码库</option>";
                                        echo "<option value='3'>网址库</option>";
                                        echo "<option value='4'>图片库</option>";
                                        echo "<option value='5'>模板库</option>";
                                        break;
                                    case '2':
                                        echo "<option value='1'>文章库</option>";
                                        echo "<option value='2' selected = 'selected'>代码库</option>";
                                        echo "<option value='3'>网址库</option>";
                                        echo "<option value='4'>图片库</option>";
                                        echo "<option value='5'>模板库</option>";
                                        break;
                                    case '3':
                                        echo "<option value='1'>文章库</option>";
                                        echo "<option value='2'>代码库</option>";
                                        echo "<option value='3' selected = 'selected'>网址库</option>";
                                        echo "<option value='4'>图片库</option>";
                                        echo "<option value='5'>模板库</option>";
                                        break;
                                    case '4':
                                        ...
                                        echo "<option value='2'>代码库</option>";
                                        echo "<option value='3'>网址库</option>";
                                        echo "<option value='4' selected = 'selected'>图片库</option>";
                                        echo "<option value='5'>模板库</option>";
                                        break;
                                    case '5':
                                        echo "<option value='1'>文章库</option>";
                                        ...
                                        echo "<option value='3'>网址库</option>";
                                        echo "<option value='4'>图片库</option>";
                                        echo "<option value='5' selected = 'selected'>模板库</option>";
                                        break;
                                    default:
                                        break;
                                }
						...
						<div class="form-group">
                            ...
                            value="<?php echo $msg['knowledge_title'] ?>" />
						</div>
						<div class="form-group">
							<label for="msg">知识内容</label>
							<script type="text/plain" id="myEditor" name="msg"><?php echo $msg['knowledge_msg']?></script>
						</div>
                        <?php endforeach; ?>
						<div class="form-group">
							<button id="submit" class="btn btn-info pull-right" onclick="return confirm('确定通过并发布吗?');">发布</button>
						</div>
					</form>
				</div>
			</div>
...
// 			});
			$("#submit").click(function() { 
				var newUrl = "adminController.php?flag=admin&src=k2&edit="+<?php echo $_GET["edit"] ?>;
